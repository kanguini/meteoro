...
export const en: Content = {
  ...
  careers: {
    hero: {
      ...
      title: 'Build with us what stands.',
      lead: 'Meteoro 24 grows with people who take construction seriously. We look for rigorous, organised people who want to get it right the first time.',
    },
    why: {
      title: 'Why Meteoro 24?',
      items: [
        { title: 'Work with method', text: 'Here we plan before we build. Rigour is not a slogan — it is how we work every day.' },
        { title: 'The whole build', text: 'From estimating to handover, you follow the entire project. You learn a lot when you see the whole thing.' },
        { title: 'Real growth', text: 'We are expanding. There is room to grow with the company and take on more responsibility.' },
        { title: 'Real accountability', text: 'We give autonomy to those who earn it and stand behind what we deliver. We look for the same in every person.' },
      ],
    },
    jobs: {
      title: 'Open positions',
      lead: 'The roles we are filling right now. Not seeing yours? Send a spontaneous application.',
      profileLabel: 'Profile',
      empty: 'There are no open positions at the moment. You can still send a spontaneous application — we keep your CV for when the right role comes up.',
      apply: 'Apply',
    ...
    spontaneous: {
      ...
      text: 'No role that fits you? Send your CV anyway. When a suitable position opens, you will be among the first to know.',
      label: 'Spontaneous application',
    },
    form: {
      title: 'Application form',
      lead: 'Fill in the fields and attach your CV. We respond to every application.',
      name: 'Full name',
      email: 'Email',
      phone: 'Phone',
      position: 'Position',
      spontaneousOption: 'Spontaneous application',
      message: 'Message',
      messageHint: 'Tell us why you want to work with us (optional).',
      cv: 'Résumé (CV)',
      cvHint: 'PDF, DOC or DOCX, up to 5 MB.',
      submit: 'Send application',
      sending: 'Sending...',
      success: 'Application received. Thank you — we will be in touch.',
      error: 'The application could not be sent. Please try again or write to us directly.',
      required: 'Required field',
      invalidEmail: 'Enter a valid email address',
      cvRequired: 'Attach your CV.',
      privacy: 'The data and CV you send are used only to assess your application.',
    },
  },
  footer: {
